...
// past the edges
	...
	// in ReDoomEd with the help of a utility function, RDE_DPSGlue_DrawInstanceIfNeeded(),
	// which needs to be called from the view's drawSelf:: method after drawing the view
	RDE_DPSGlue_DrawInstanceIfNeeded();
#endif
