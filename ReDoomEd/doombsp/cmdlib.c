...
#ifndef REDOOMED  // Original (Disable for ReDoomEd - these are already defined in DoomEd & <unistd.h>)
...
#ifndef REDOOMED  // Original (Disable for ReDoomEd - defined instead in doombsp.m in order to use objc exceptions)
...
#ifndef REDOOMED // Original (Disable for ReDoomEd - unused code, references myargv & myargc)
...
#ifndef REDOOMED // Original (Disable for Cocoa - already defined in DoomEd)
