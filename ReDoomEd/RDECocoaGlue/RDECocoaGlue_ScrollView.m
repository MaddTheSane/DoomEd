...
@implementation NSScrollView (RDECocoaGlue_ScrollViewMethods)

- (id) initFrame: (const NSRect *) frameRectPtr
{
    return [self initWithFrame: *frameRectPtr];
}
...
- (id) setDocView: (NSView *) aView
{
    ...
    return nil; // the expected return value is the old document view, but ok to just return nil
}

- (id) setHorizScrollerRequired: (BOOL) flag
{
    [self setHasHorizontalScroller: flag];
...
{
    [self setHasVerticalScroller: flag];
