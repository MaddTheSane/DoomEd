...
#define NXRectFill(rectPtr)                                 \
            NSRectFill(macroRDE_PixelCenteredRect(*(rectPtr)))

#define NXRectFillList                                      \
            RDE_NXRectFillList

#define NXFrameRectWithWidth                                \
            RDE_DPSGlue_NXFrameRectWithWidth

#define NXEraseRect(rectPtr)                                \
            NSEraseRect(macroRDE_PixelCenteredRect(*(rectPtr)))
