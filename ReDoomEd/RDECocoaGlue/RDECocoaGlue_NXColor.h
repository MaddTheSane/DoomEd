...
#define NXRedComponent(color) ((color).r)
#define NXBlueComponent(color) ((color).b)
#define NXGreenComponent(color) ((color).g)
#define NXAlphaComponent(color) ((color).a)
