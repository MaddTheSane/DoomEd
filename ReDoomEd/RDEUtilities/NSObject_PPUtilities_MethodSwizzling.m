...
#ifdef REDOOMED
    // PikoPixel's PP_SDK_* macros aren't available in ReDoomEd, so manually define the
    // _SUPPORTS_OBJC_RUNTIME_API_VERSION_2 macro, hardcoded to 'true' (v2 runtime APIs are
    // supported on GNUstep and on OS X 10.5+ SDKs).
